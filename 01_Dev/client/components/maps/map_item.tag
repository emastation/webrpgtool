<map-item>
  <div class="ui segment">
    ...
    <p><br />
      ...
      <a href="javascript:void(0)" if={isLogin} onclick={goToMapEdit}>編集&nbsp;</a>
      <a href="javascript:void(0)" onclick={goToMapPage(opts.map._id)} class="discuss btn btn-default">詳細</a>
    </p>
  </div>
